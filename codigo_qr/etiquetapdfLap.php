...
if ($id_equipo !== null) {
    ...
    $sql = "SELECT numero_serie, area, clave, fechaAs FROM form_laptop WHERE Id = $id_equipo";
    ...
    if ($result) {
        ...
        if ($row && isset($row['numero_serie'])) {
            ...
            $qrContent = "http://11.11.1.39/inventario-serva/invent/laptops.php?busqueda=$numero_serie&enviar=";
            ...
            $pdf->SetFont('Arial', '', 9);  // Establecer un tamaño de fuente más grande
            $pdf->Cell(60);
