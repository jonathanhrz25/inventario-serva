...
if ($id_equipo !== null) {
    ...
    $sql = "SELECT numero_serie, area, clave, fechaAs FROM form_monitor WHERE Id = $id_equipo";
    ...
    if ($result) {
        ...
        if ($row && isset($row['numero_serie'])) {
            ...
            $qrContent = "http://11.11.1.39/inventario-serva/invent/monitores.php?busqueda=$numero_serie&enviar=";
