  ...
  <footer class="fixed-bottom bg-blue bg-gradient text-center text-lg-start text-white">
    ...
    <div class="footer-container">
      ...
      <div class="toggle-container">
        <i class="fa fa-chevron-down toggle-button" onclick="toggleFooterContent()"></i>
      </div>
    </div>
    ...
    <div class="footer-content text-center">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-4 mb-3 text-start text-md-center text-center">
            <h5>Proyecto</h5>
            <p>Inventario Serva</p>
            <p>Consiste en tener el control y el inventariado de todo el equipo de cómputo que se cuenta tanto en Matriz
              como en los demás Cedis.</p>
          </div>
        </div>
      </div>
    </div>
