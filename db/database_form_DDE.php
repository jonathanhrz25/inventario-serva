...
// Recopilar datos del formulario - DDE
$clave = $_POST['clave'];
$equipo = $_POST['equipo'];
$serie = $_POST['serie'];
$estado = $_POST['estado'];
...
try {
    ...
    $sql1 = "INSERT INTO form_dde (equipo, numero_serie, clave, estado, proceso, marca, 
    ...
    if (array_key_exists($cedis, $cedis_tablas)) {
        ...
        echo "<script> alert('Sus datos han sido registrados en ambas bases de datos');
                window.location ='../invent/dde.php';</script>";
    } else {
        ...
        echo "<script> alert('ERROR: CEDIS no válido');
                window.location ='../formulario/formularioDDE.php';</script>";
    }
} catch (Exception $e) {
