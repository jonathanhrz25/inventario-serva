...
$sql = "SELECT * FROM form_hh WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_hh SET numero_serie = '$numero_serie', clave = '$clave', ip = '$ip', marca = '$marca', modelo = '$modelo', usuario = '$usuario', area = '$area', estatus = '$Estatus', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/handHeld.php");
        exit;
    } else {
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Hand Held</h1>
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="ip" value="<?php echo $mostrar['ip']; ?>" required>
            </div>
