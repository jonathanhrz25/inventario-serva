...
$sql = "SELECT * FROM form_impresora WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_impresora SET numero_serie = '$numero_serie', clave = '$clave', usuario = '$usuario' , area = '$area', estado = '$estado', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/impresoras.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../invent/impresoras.php">
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Impresora</h1>
        <form action="" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area">
                    <option value="">Seleccione el Area de la Impresora…</option>
