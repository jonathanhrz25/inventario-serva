...
$sql = "SELECT * FROM form_laptop WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_laptop SET numero_serie = '$numero_serie', clave = '$clave', usuario = '$usuario' , area = '$area', estado = '$estado', especificaciones = '$especificaciones', proceso = '$proceso', responsiva = '$responsiva', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/laptops.php");
        exit;
    } else {
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Laptop</h1>
        <form action="" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area">
                    <option value="">Seleccione el Area de la Laptop…</option>
                    ...
                    <option value="ASISTENTE DE DIRECCION" <?php if ($mostrar['area'] == "ASISTENTE DE DIRECCION") echo "selected"; ?>>Asistente de Direccion</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="responsiva" name="responsiva">
                    <option value="<?php echo $mostrar['responsiva']; ?>">Seleccione Uno…</option>
