...
$sql = "SELECT * FROM form_monitor WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_monitor SET numero_serie = '$numero_serie', clave = '$clave', marca = '$marca', modelo = '$modelo', usuario = '$usuario', area = '$area', cedis = '$cedis', estado = '$estado', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/monitores.php");
        exit;
    } else {
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Monitores</h1>
