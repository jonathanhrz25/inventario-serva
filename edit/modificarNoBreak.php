...
$sql = "SELECT * FROM form_nobreak WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_nobreak SET numero_serie = '$numero_serie', clave = '$clave', usuario = '$usuario', cedis = '$cedis', area = '$area', marca = '$marca', modelo = '$modelo', estado = '$estado', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/noBreak.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../invent/noBreak.php">
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - NoBreak</h1>
        <form action="" method="POST">
            <!-- Campos del formulario -->
            <div class="form-group">
                <label for="numero_serie">Numero de Serie:</label>
                <input type="text" class="form-control" name="numero_serie"
                    value="<?php echo $mostrar['numero_serie']; ?>">
            </div>

            <div class="form-group">
                <label for="clave">Clave:</label>
                <input type="text" class="form-control" name="clave" value="<?php echo $mostrar['clave']; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="cedi" name="cedi">
                    <option value="">Seleccione el Cedis del NoBreak…</option>
            ...
            <div class="form-group">
                <label for="marca" class="form-label" name="marca">Marca:</label><br>
                    <select class="form-control" id="marca" name="marca">
                        <option value="">Selecciona la marca del NoBreak…</option>
                        <option value="CYBERPOWER" <?php if ($mostrar['area'] == "CYBERPOWER") echo "selected"; ?>>CyberPower</option>
                        <option value="ISB SOLA BASIC" <?php if ($mostrar['area'] == "ISB SOLA BASIC") echo "selected"; ?>>ISB SOLA BASIC</option>
                    </select>
                </label>
            </div><br>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="modelo" class="form-control" id="modelo" value="<?php echo $mostrar['modelo']; ?>" aria-describedby="nameHelp"
