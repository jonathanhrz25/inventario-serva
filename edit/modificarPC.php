...
$sql = "SELECT * FROM form_pc WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_pc SET numero_serie = '$numero_serie', clave = '$clave', estado = '$status', proceso = '$proceso', marca = '$marca', modelo = '$modelo', especificaciones = '$especificaciones', responsiva = '$responsiva', cedis = '$cedis', usuario = '$usuario', area = '$area', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
        <div class="container-fluid">
            <a class="navbar-brand text-white" href="../invent/pc.php">
...
<body>
    ...
    <div class="container col-8 mt-5"><br>
        <h1 class="display-6">Modificar Registro - PC</h1>
        <form action="" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="estado" class="form-control" id="estado" aria-describedby="nameHelp"
                    value="<?php echo $mostrar['estado']; ?>" placeholder="Porcentaje del Equipo" />
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="proceso" name="proceso">
                    ...
                    <option value="Reparacion" <?php if ($mostrar['proceso'] == "Reparacion")echo "selected"; ?>>Enreparación</option>
                </select>
            </div>


            <div class="form-group">
                <label for="responsiva">Responsiva: </label><br>
                <select class="form-control" id="responsiva" name="responsiva">
                    <option value="">Seleccione Uno…</option>
                    <option value="Si" <?php if ($mostrar['responsiva'] == "Si")echo "selected"; ?>>Si</option>
                    <option value="No" <?php if ($mostrar['responsiva'] == "No")echo "selected"; ?>>No</option>
                </select>
            </div>
