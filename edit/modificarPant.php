...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_pantalla SET numero_serie = '$numero_serie', clave = '$clave', usuario = '$usuario' , area = '$area', estado = '$estado', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Pantalla</h1>
        <form action="" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area">
                    <option value="">Seleccione el Area de la Pantalla…</option>
