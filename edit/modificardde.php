...
$sql = "SELECT * FROM form_dde WHERE Id = $id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_dde SET numero_serie = '$numero_serie', clave = '$clave', usuario = '$usuario' , area = '$area', estado = '$estado', proceso = '$proceso', fechaCo = '$fechaCo', fechaAs = '$fechaAs', comentarios_observaciones = '$comentarios_observaciones' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../invent/dde.php");
        exit;
    } else {
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1 class="display-6">Modificar Registro - Disco Duro Externo</h1>
