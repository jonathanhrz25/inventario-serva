...
<body>
    ...
    <!-- Inicio de Formulario Impresora -->
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_impresora.php">
            ...
            <div class="form-group">
                <label for="proceso" class="form-label" name="proceso">Procedimiento: </label><br>
                    <select class="form-control" id="proceso" name="proceso">
                        <option value="">Seleccione el proceso de la impresora</option>
