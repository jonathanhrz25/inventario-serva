...
<body>
    ...
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_lectorCB.php">
            ...
            <div class="form-group">
                <label for="equipo" class="form-label" name="equipo">Tipo de Equipo: </label><br>
                    <select class="form-control" id="equipo" name="equipo" onchange="actualizarClave()">
                        ...
                        <option value="LC LECTOR CODIGO DE BARRAS">Lector codigo de barras</option>
                    </select>
                </label>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area" onchange="actualizarClave()">
                    ...
                    <option value="AR ADMINISTRACION REFACCIONARIAS">Administracion Refaccionarias</option>
                    <option value="ALMACEN">Almacen</option>
                    <option value="AC ATENCION A CLIENTES">Atencion a Clientes</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="numero_serie" id="numero_serie" aria-describedby="nameHelp" placeholder="No. Serie" />
            </div>

            <div class="form-group">
                <label for="marca" class="form-label" name="marca">Marca:</label><br>
                    <select class="form-control" id="marca" name="marca">
                        <option value="">Seleccione la marca del lectorCB…</option>
            ...
            <div class="form-group mb-3">
                <label for="exampleInputEmail1" class="form-label">No. de Parte: </label>
                <input type="text" name="parte" class="form-control" id="parte" aria-describedby="nameHelp"
                    placeholder="Num. de parte del Equipo" />
            </div>
            ...
            <div class="form-group">
                <label for="estado" class="form-label" name="estado">Estado del Lector de Codigo de Barras: </label><br>
                <select class="form-control" id="estado" name="estado">
                    <option value="">Seleccione el estado de la PC…</option>
