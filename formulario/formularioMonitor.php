...
<body>
    ...
    <!-- Inicio de Formulario Monitor -->
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_monitor.php">


            <!-- Clave y verificacion en la bd -->
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="cedi" name="cedi" onchange="actualizarClave()">
                    <option value="">Seleccione el Cedis del Monitor…</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="equipo" name="equipo" onchange="actualizarClave()">
                    ...
                    <option value="MN MONITOR">Monitor</option>
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area" onchange="actualizarClave()">
                    <option value="">Seleccione el area del Monitor…</option>
                    <option value="AD Adquisiciones">Adquisiciones</option>
                    <option value="CE Administracion Cedis">Administracion Cedis</option>
                    <option value="CE Administracion Refaccionaria">Administracion Refaccionaria</option>
                    ...
                    <option value="CD Cedis">Cedis</option>
            ...
            <div class="form-group">
                <label for="proceso" class="form-label" name="estado">Procedimiento: </label><br>
                <select class="form-control" id="proceso" name="proceso">
                    <option value="">Seleccione el estado del monitor…</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="marca" name="marca">
                    <option value="">Seleccione la marca del Monitor…</option>
            ...
            <div class="form-group">
                <label for="exampleInputEmail1" class="form-label" name="tipoPantalla">Tipo de Pantalla: </label><br>
                <select class="form-control" id="tipo_pantalla" name="tipo_pantalla">
                    <option value="">Seleccione Uno …</option>
                    <option value="Pantalla Plana">Pantalla Plana</option>
                    <option value="Pantalla Curva">Pantalla Curva</option>
                </select>
                </label>
            </div>

            <div class="form-group mb-3">
                <label for="exampleInputEmail1" class="form-label">Tamaño de Pantalla (pulgadas): </label>
                <input type="text" name="tamaño_pantalla" class="form-control" id="tamaño_pantalla"
                    aria-describedby="nameHelp" placeholder="Ingresa el tamaño de Pantalla" />
            </div>
