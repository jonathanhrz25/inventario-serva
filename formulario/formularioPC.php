...
<body>
    ...
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_PC.php">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="cedis" name="cedis" onchange="actualizarClave()">
                    ...
                    <option value="VE VERACRUZ">Veracruz</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="responsiva" name="responsiva">
                    <option value="">Seleccione si el equipo cuenta con una responsiva…</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="proceso" name="proceso">
                    <option value="">Seleccione el procedimiento de la PC…</option>
