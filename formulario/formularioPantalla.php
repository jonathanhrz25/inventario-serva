...
<body>
    ...
    <!-- Inicio de Formulario Pantalla -->
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_pantalla.php">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="proceso" name="proceso">
                    <option value="">Seleccione el proceso de la pantalla</option>
