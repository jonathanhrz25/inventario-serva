...
<body>
    ...
    <div class="container col-8">
        <form id="formulario" method="POST" action="../db/database_form_noBreak.php">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="area" name="area" onchange="actualizarClave()">
                    ...
                    <option value="MA Mesas Almacen">MESAS ALMACEN</option>
            ...
            <div class="form-group">
                <label for="estado" class="form-label" name="estado">Estado del NoBreak: </label><br>
                    <select class="form-control" id="estado" name="estado">
                        <option value="">Seleccione el estado del NoBreak</option>
