...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a class="btn btn-success ml-2" href="../formulario/formularioMonitor.php">Añadir</a>
            </div>
        </nav>
            ...
            <ul class="navbar-nav flex-column justify-content-center">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item d-flex justify-content-between" href="../invent/lectorCB.php">Lector de Codigo de Barras</a><i class="bi bi-upc"></i></a>
                    </div>
                </li>
            </ul>
        </nav>
    ...
    <body style="padding-top: 70px;">
        ...
        <h1 class="display-6">Tabla de Inventario - Monitores</h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if ($order_by === 'clave'): ?>
                                <a href="http://localhost/inventario-serva/invent/monitores.php?busqueda=&enviar=">Clave</a>
                            <?php else: ?>
                                <a class="text-white"
                ...
                $sql_paginacion = "SELECT * FROM form_monitor WHERE 
                    ...
                    while ($mostrar = mysqli_fetch_array($result_paginacion)) {
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php
                                if (strlen($mostrar['numero_serie']) > 10) {
                                    echo substr($mostrar['numero_serie'], 0, 10) . '<span class="more-content">' . substr($mostrar['numero_serie'], 10) . '</span>';
                                    echo '<span class="show-more-btn"> Ver más</span>';
                                } else {
                                    echo $mostrar['numero_serie'];
                                }
                                ?>
                            </td>
                            <td class="text-center"><?php echo $mostrar['marca'] ?></td>
                            <td class="text-center"><?php echo $mostrar['modelo'] ?></td>
                            <td class="text-center"><?php echo $mostrar['tipo_pantalla'] ?></td>
                            <td class="text-center"><?php echo $mostrar['tamaño_pantalla'] ?></td>
                            ...
                            <td class="icon-cell"><a href="../codigo_qr/generarMonit.php?id=<?php echo $mostrar['Id']; ?>"> <i class="fa fa-qrcode fa-2x"></i></a></td>
                            <td class="icon-cell"><a href="../edit/modificarMonit.php?id=<?php echo $mostrar['Id']; ?>"> <i class="fa fa-pencil-square-o fa-2x"></i></a></td>
                            <td class="icon-cell"><a href="../edit/eliminarMonit.php?id=<?php echo $mostrar['Id']; ?>" onclick="return confirm('¿Estás seguro?')"> <i class="fa fa-trash-o fa-2x"></i></a></td>
                        </tr>
                    <?php }
                } else {
        ...
        $sql_total_resultados = "SELECT COUNT(*) as total FROM form_monitor WHERE 
        (clave LIKE '%$busqueda%' OR numero_serie LIKE '%$busqueda%' OR area LIKE '%$busqueda%' 
        OR usuario LIKE '%$busqueda%' OR cedis LIKE '%$busqueda%') AND status = 1";
