...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a class="btn btn-success ml-2" href="../formulario/formularioPantalla.php">Añadir</a>
            </div>
        </nav>
    ...
    <body style="padding-top: 70px;">
        ...
        <h1 class="display-6">Tabla de Inventario - Pantallas</h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if ($order_by === 'clave'): ?>
                                <a href="http://localhost/inventario-serva/invent/pantallas.php?busqueda=&enviar=">Clave</a>
                            <?php else: ?>
                                <a class="text-white"
                        ...
                        <th>Cedis</th>
                        <th>Procedimiento</th>
                        <th>Fecha de Compra de Equipo</th>
                ...
                $sql_paginacion = "SELECT * FROM form_pantalla WHERE 
                ...
                <tr>
                    ...
                    <td class="icon-cell"><a href="../codigo_qr/generarPanta.php?id=<?php echo $mostrar['Id']; ?>"> <i class="fa fa-qrcode fa-2x"></i></a></td>
                    <td class="icon-cell"><a href="../edit/modificarPant.php?id=<?php echo $mostrar['Id']; ?>"> <i class="fa fa-pencil-square-o fa-2x"></i></a></td>
                    <td class="icon-cell"><a href="../edit/eliminarPant.php?id=<?php echo $mostrar['Id']; ?>" onclick="return confirm('¿Estás seguro?')"> <i class="fa fa-trash-o fa-2x"></i></a></td>
                </tr>
                <?php }
                } else {
        ...
        $sql_total_resultados = "SELECT COUNT(*) as total FROM form_pantalla WHERE 
        (clave LIKE '%$busqueda%' OR numero_serie LIKE '%$busqueda%' OR area LIKE '%$busqueda%' 
        OR usuario LIKE '%$busqueda%' OR cedis LIKE '%$busqueda%') AND status = 1";
