...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a class="btn btn-success ml-2" href="../formulario/formularioSwitch_Access.php">Añadir</a>
            </div>
        </nav>
            ...
            <ul class="navbar-nav flex-column justify-content-center">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item d-flex justify-content-between" href="../invent/lectorCB.php">Lector de Codigo de Barras</a>
                    </div>
                </li>
            </ul>
        </nav>
    ...
    <body style="padding-top: 70px;">
        ...
        <h1 class="display-6">Tabla de Inventario - Switches y Access Points</h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if ($order_by === 'clave'): ?>
                                <a href="http://localhost/inventario-serva/invent/switchesyaccessp.php?busqueda=&enviar=">Clave</a>
                            <?php else: ?>
                                <a class="text-white"
                ...
                $sql_paginacion = "SELECT * FROM form_switch_aps WHERE 
                ...
                <tr>
                    ...
                    <td class="text-center <?php 
                        if ($mostrar['estado'] == 'NUEVO') {
                            echo 'estado-nueva';
                        } elseif ($mostrar['estado'] == 'BUENO') {
                            echo 'estado-buena';
                        } elseif ($mostrar['estado'] == 'REGULAR') {
                            echo 'estado-regular';
                        } elseif ($mostrar['estado'] == 'NO FUNCIONA') {
                    ...
                    <td class="icon-cell"><a href="../codigo_qr/generarSyA.php?id=<?php echo $mostrar['Id']; ?>"><i class="fa fa-qrcode fa-2x"></i></a></td>
                    <td class="icon-cell"><a href="../edit/modificarSyA.php?id=<?php echo $mostrar['Id']; ?>"><i class="fa fa-pencil-square-o fa-2x"></i></a></td>
                    <td class="icon-cell"><a href="../edit/eliminarSyA.php?id=<?php echo $mostrar['Id']; ?>" onclick="return confirm('¿Estás seguro?')"><i class="fa fa-trash-o fa-2x"></i></a></td>
                </tr>
                <?php }
                } else {
        ...
        $sql_total_resultados = "SELECT COUNT(*) as total FROM form_switch_aps WHERE 
        (clave LIKE '%$busqueda%' OR numero_serie LIKE '%$busqueda%' OR area LIKE '%$busqueda%' 
        OR usuario LIKE '%$busqueda%' OR cedis LIKE '%$busqueda%') AND status = 1";
