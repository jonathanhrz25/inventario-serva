...
<div class="text-center">
    <h1 class="display-5">Disco Duro Externo</h1>
</div>
        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $sql = "SELECT * FROM form_dde WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%') AND proceso = 'Mantenimiento'";
                ...
                <tr>
                    ...
                    <td><a href="../mantenimiento/modificardde.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
