...
<div class="text-center">
    <h1 class="display-5">Hand Helds</h1>
</div>
        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    // Consulta SQL para buscar en la tabla 'form_hand held'
                    $sql = "SELECT * FROM form_hh WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%' or ip LIKE '%$busqueda%') AND proceso = 'Mantenimiento'";
                ...
                <tr>
                    ...
                    <td><a href="../mantenimiento/modificarHH.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
