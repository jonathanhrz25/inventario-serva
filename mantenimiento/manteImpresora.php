...
<div class="text-center">
    <h1 class="display-5">Impresoras</h1>
</div>
        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    // Consulta SQL para buscar en la tabla 'form_impresora'
                    $sql = "SELECT * FROM form_impresora WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%') AND proceso = 'Mantenimiento'";
                ...
                <tr>
                    ...
                    <td><a href="../mantenimiento/modificarImpre.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
