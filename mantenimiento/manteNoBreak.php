        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    // Consulta SQL para buscar en la tabla 'form_nobreak'
                    $sql = "SELECT * FROM form_nobreak WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%') AND proceso = 'Mantenimiento'";
                ...
                <tr>
                    ...
                    <td><a href="../mantenimiento/modificarNoBreak.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
