    ...
    <header>
        <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #081856!important;">
            <div class="container-fluid">
                <a class="navbar-brand text-white" href="../php/equiposMantenimientos.php">
...
<div class="text-center">
    <h1 class="display-5">Switches y Access Points</h1>
</div>
        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $sql = "SELECT * FROM form_switch_aps WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%' or tipo_dispositivo LIKE '%$busqueda%') AND proceso = 'Mantenimiento'";
                ...
                <tr>
                    ...
                    <td><?php echo $mostrar['tipo_dispositivo'] ?></td>
                    ...
                    <td><a href="../mantenimiento/modificarSyA.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
