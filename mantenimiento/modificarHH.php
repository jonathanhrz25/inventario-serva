...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_hh SET proceso = '$proceso' WHERE Id = $id";
    ...
    if ($update_result) {
        ...
        header("Location: ../php/equiposMantenimientos.php");
        exit;
    } else {
...
<header>
    <nav class="navbar navbar-dark bg-dark fixed-top" style="background-color: #000000!important;">
        <a class="navbar-brand text-white" href="../php/equiposMantenimientos.php">Sistema de Inventario</a>
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1>Modificar Registro - Hand Held</h1>
            ...
            <div class="form-group">
                <label for="proceso">Procedimiento: </label><br>
                    <select class="form-control" id="proceso" name="proceso" >
                        <option value="<?php echo $mostrar['proceso']; ?>">Seleccione el proceso para la Hand Held...</option>
