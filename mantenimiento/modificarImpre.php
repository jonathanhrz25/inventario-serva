...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_sql = "UPDATE form_impresora SET proceso = '$proceso' WHERE Id = $id";
...
<body>
    ...
    <div class="container col-8 mt-5"><br><br>
        <h1>Modificar Registro - Impresora</h1>
            ...
            <div class="form-group">
                <label for="proceso">Procedimiento: </label><br>
                    <select class="form-control" id="proceso" name="proceso" >
                        <option value="<?php echo $mostrar['proceso']; ?>">Seleccione Uno…</option>
