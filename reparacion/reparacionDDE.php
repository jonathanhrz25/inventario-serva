        ...
        <div class="table-responsive">
            <table class="table table-hover table-Light">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $sql = "SELECT * FROM form_dde WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%') AND proceso = 'Reparacion'";
                ...
                <tr>
                    ...
                    <td><a href="../reparacion/modificardde.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
