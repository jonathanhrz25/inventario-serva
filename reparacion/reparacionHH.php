        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $sql = "SELECT * FROM form_hh WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%' or ip LIKE '%$busqueda%') AND proceso = 'Reparacion'";
                ...
                <tr>
                    ...
                    <td><a href="../reparacion/modificarHH.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
