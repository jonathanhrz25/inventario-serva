        ...
        <table class="table table-hover table-Light">
            <thead class="table-dark">
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $sql = "SELECT * FROM form_nobreak WHERE (clave LIKE '%$busqueda%' or numero_serie LIKE '%$busqueda%') AND proceso = 'Reparacion'";
                ...
                <tr>
                    ...
                    <td><a href="../reparacion/modificarNoBreak.php?id=<?php echo $mostrar['Id']; ?>">Modificar</a></td>
                </tr>
                <?php
                    }
                }
